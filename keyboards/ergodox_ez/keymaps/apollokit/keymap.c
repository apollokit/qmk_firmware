...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [1] = LAYOUT_ergodox(
    ...
    KC_TRANSPARENT,KC_GRAVE,KC_7,KC_8,KC_9,KC_ASTR,KC_F12,
    KC_TRANSPARENT,KC_4,RALT_T(KC_5),RSFT_T(KC_6),KC_PLUS,KC_TRANSPARENT,
  ...
  [5] = LAYOUT_ergodox(
    ...
    KC_TRANSPARENT,    LCTL(KC_X),LCTL(KC_G),LCTL(KC_C),LCTL(KC_V),LCTL(KC_Z),LALT(KC_F1),
    KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,LCTL(LSFT(KC_C)),LCTL(LSFT(KC_V)),
    KC_TRANSPARENT,KC_TRANSPARENT,
    KC_TRANSPARENT,
    LCTL(KC_BSPACE),KC_TRANSPARENT,KC_TRANSPARENT,

    KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,
    KC_TRANSPARENT,RCTL(KC_J),RCTL(KC_L),RCTL(KC_U),RCTL(KC_Y),RCTL(KC_SCOLON),KC_TRANSPARENT,
    RCTL(KC_M),RCTL(KC_N),RCTL(KC_E),RCTL(KC_I),RCTL(KC_O),KC_TRANSPARENT,
    KC_TRANSPARENT,RCTL(KC_K),RCTL(KC_H),KC_TRANSPARENT,KC_TRANSPARENT,RCTL(KC_SLASH),KC_TRANSPARENT,
    KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,
    KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,
    KC_TRANSPARENT,
    RCTL(KC_ENTER),RCTL(KC_SPACE)),
